-- Migration simplifiée pour remplacer reference par serial_number
BEGIN;

-- Supprimer la table components et la recréer proprement
DROP TABLE IF EXISTS order_components CASCADE;
DROP TABLE IF EXISTS components CASCADE;

-- Recréer la table components avec serial_number
...
SELECT 'Migration terminée - composants créés:' as info;
SELECT serial_number, name, type, stock_quantity FROM components;